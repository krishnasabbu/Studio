...
const EmailTemplatePage: React.FC<EmailTemplatePageProps> = ({ isViewing = false, variables, conditions }) => {
        ...
        <div className="grid grid-cols-12 gap-6 h-full">
          ...
          <div className={isViewing ? "col-span-4" : "col-span-4"}>
            <Card className="h-full">
              <PropertiesPanel isViewing={isViewing} variables={variables} conditions={conditions} />
            </Card>
          </div>
        </div>
      </div>
